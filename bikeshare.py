#resources used: https://github.com/adelabuhashim/Explore-US-Bikeshare-Data/blob/master/bikeshare_2.py
# and the knowledge center in udacity
...
def get_filters():
    ...
    city = input("please enter the required city:")
    while city not in ["chicago","new york city", "washington"]:
        city = input("choose between these only, chicago, new york city, washington").lower()

    # TO DO: get user input for month (all, january, february, ... , june)
    month = input("please enter a month:")
    while month not in ['all','january', 'february', 'march', 'april', 'may', 'june']:
        month = input('select these months only, january, february, ... , june:')
...
def user_stats(df):
    ...
    try:
        ...
        print("earliest year of birth:",earliest_year_of_birth,
            ", most recent one:",most_recent_year_of_birth,
            "and the most common one: ",most_common_year_of_birth)
    except:
   ...
   #### source for this function https://github.com/adelabuhashim/Explore-US-Bikeshare-Data/blob/master/bikeshare_2.py
def raw_data (df):
